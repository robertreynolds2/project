...
def sslproxies():
    r = requests.get("http://proxyrack.net/rotating/usa/")
            ...
            if proxies is not None:
                if len(proxies) > 0:
                    ...
                    if inp == "2":
                        ...
                        continue
            r = requests.post("https://www.coinbase.com/users/oauth_signup",
                              data="accept_user_agreement=true&application_client_id=2d06b9a69c15e183856ff52c250281f6d93f9abef819921eac0d8647bb2b61f9&email={}&first_name=Susj&last_name=Nnsns&locale=en-US&password=@".format(
                                  email),
                              headers={
